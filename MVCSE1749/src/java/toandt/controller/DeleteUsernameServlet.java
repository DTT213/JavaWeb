 ...
 * @author Toan
 */
@WebServlet(name = "DeleteUsernameServlet", urlPatterns = {"/DeleteUsernameServlet"})
public class DeleteUsernameServlet extends HttpServlet {
    /**
